...
public class ShowsJJFrame extends JFrame
{
	JLabel label_screen;
	JLabel ttl1,lthr1,lthr2;
	...
	ShowsJJFrame()
	{
		super("Showtimings for Jayeshbhai Jordaar");
		setLayout(null);
		...
		ttl1 = new JLabel("Showtimings for Jayeshbhai Jordaar movie:");
		ttl1.setBounds(100,70,550,80);
		
		lthr1 = new JLabel("R World:");
		lthr1.setBounds(100,180,150,40);
		
		lthr2 = new JLabel("Galaxy Cinema:");
		lthr2.setBounds(100,320,190,40);
		
		bShow1 = new JButton("11:50");
		bShow1.setBounds(100,220,100,50);
		
		bShow2 = new JButton("5:30");
		bShow2.setBounds(270,220,100,50);
		
		bShow3 = new JButton("06:30");
