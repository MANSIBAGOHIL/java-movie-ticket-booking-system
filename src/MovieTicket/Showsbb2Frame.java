...
public class Showsbb2Frame extends JFrame
{
	JLabel label_screen;
	JLabel ttl1,lthr1,lthr2,lthr3,lthr4;
	JButton bShow1,bShow2,bShow3,bShow4,bShow5,bShow6,bShow7;
	Font f1,f2;
	MyActionListener ml = new MyActionListener(this);
	
	Showsbb2Frame()
	{
		super("Showtimings for Bhool Bhulaiyaa 2");
		setLayout(null);
		...
		ttl1 = new JLabel("Showtimings for Bhool Bhulaiyaa 2 movie:");
		ttl1.setBounds(100,70,500,80);
